...
- pnpm test runs all suites: unit, e2e, accessibility, coverage (80% min), performance (benchmarked thresholds)
...
**Post-Design Re-evaluation (Phase 1 Completion):** ✅ ALL GATES PASS. The design artifacts (`data-model.md`, `contracts/`, `quickstart.md`) are aligned with the constitution.
