...
✅ GEMINI.md - Should reference new CI workflow principle

Follow-up TODOs:
- RATIFICATION_DATE placeholder retained as TODO - requires project owner decision
- Update GEMINI.md to reference Principle XI for CI workflow guidance
...
- Agent/AI assistant instructions in GEMINI.md (or AGENTS.md for multi-assistant projects)
...
6. Update runtime guidance (GEMINI.md, README.md, docs/)
...
- Use GEMINI.md for detailed runtime development guidance (AI assistant instructions)
